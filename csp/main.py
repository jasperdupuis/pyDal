...
FS = 25600
num_seconds = 3
N = FS * num_seconds #largest effect on del_alpha and max alpha
...
TOTAL_SECONDS = 60  #work on a minute of data
n_secs = [3,5,7,10,15,20]
r_dictionary= dict()
x = data[:TOTAL_SECONDS*FS]
for num_seconds in n_secs:
    ...
    samples,timestamps = data_methods.divide_time_series(x,overlap_major,FS,num_seconds)
    ...
    r_dictionary[num_seconds] = temp_dict
