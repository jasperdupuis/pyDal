...
# FREQS = [25,31.5,40,50,63,80,100,125,160,200,250,315,400,500]
FREQS = [10,12.5,16,20]
RX_HYD_DEPTH = 46 # m
TX_DEPTH = 36
...
for FREQ in FREQS:
    ...
    # Save data
    with open('results/emerald/data/emerald_'+str(FREQ)+'.txt', 'w') as f:
        f.write('X_RAM (m):')
    ...
    plt.legend()
    plt.savefig( dpi = 300,
                fname = 'results/emerald/png/emerald_'+str(FREQ)+'.png')
    plt.savefig(dpi = 300,
                fname = 'results/emerald/pdf/emerald_'+str(FREQ)+'.pdf')
    plt.close('all')